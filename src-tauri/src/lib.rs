...
fn localized_menu_label(language: &str, key: &str) -> &'static str {
    match (language, key) {
        ...
        ("zh-TW", "quit") => "退出",
        ("ja-JP", "input") => "テキスト翻訳",
        ("ja-JP", "screenshot") => "スクリーンショット翻訳",
        ("ja-JP", "selection") => "選択範囲翻訳",
        ("ja-JP", "settings") => "設定",
        ("ja-JP", "quit") => "終了",
        ("ko-KR", "input") => "텍스트 번역",
        ("ko-KR", "screenshot") => "스크린샷 번역",
        ("ko-KR", "selection") => "선택 영역 번역",
        ("ko-KR", "settings") => "설정",
        ("ko-KR", "quit") => "종료",
        ("fr-FR", "input") => "Traduction de texte",
        ("fr-FR", "screenshot") => "Traduction de capture",
        ("fr-FR", "selection") => "Traduction de sélection",
        ("fr-FR", "settings") => "Paramètres",
        ("fr-FR", "quit") => "Quitter",
        ("es-ES", "input") => "Traducción de texto",
        ("es-ES", "screenshot") => "Traducción de captura",
        ("es-ES", "selection") => "Traducción de selección",
        ("es-ES", "settings") => "Configuración",
        ("es-ES", "quit") => "Salir",
        ("de-DE", "input") => "Textübersetzung",
        ("de-DE", "screenshot") => "Screenshot-Übersetzung",
        ("de-DE", "selection") => "Auswahlübersetzung",
        ("de-DE", "settings") => "Einstellungen",
        ("de-DE", "quit") => "Beenden",
        ("pt-PT", "input") => "Tradução de texto",
        ("pt-PT", "screenshot") => "Tradução de captura",
        ("pt-PT", "selection") => "Tradução de seleção",
        ("pt-PT", "settings") => "Configurações",
        ("pt-PT", "quit") => "Sair",
        _ => match key {
